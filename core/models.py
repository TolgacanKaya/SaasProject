...
# YENİ: Pazaryeri filtrelemesi için Kategori modeli
...
class Business(models.Model):
    ...
    # YENİ: Senin eklediğin harika özellikler 👇
    ...
    # YENİ EKLENEN PREMİUM SÜTUNLARI
...
class Service(models.Model):
    # İşletmeye seçenek sunuyoruz (Dakika, Saat, Gün vs.)
    DURATION_CHOICES = (
        ('minutes', 'Dakika'),
        ('hours', 'Saat'),
        ('days', 'Gün'),
    ...
    # YENİ EKLENEN KISIM: Hizmetin nerede verileceği
    LOCATION_CHOICES = (
    ...
    # YENİ: Süre artık zorunlu değil (blank=True, null=True)
    ...
    # YENİ: Dakikayı saate çeviren veya birimi ekleyen akıllı Python fonksiyonu
    @property
    def formatted_duration(self):
        ...
        # Diğer birimler için (Örn: 3 Gün, 2 Hafta)
